...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(SubscriptionController::class)->group(function () {
        Route::get('/subscriptions/payments', 'payment_history')->name('subscription.payments');
        Route::post('/subscriptions/payment/update/{id}', 'payment_history_update')->name('subscription.transaction.update');
        Route::get('/subscriptions/payment/delete/{id}', 'payment_history_delete')->name('subscription.transaction.destroy');
    });
    ...
    // Quotations
    Route::controller(AdminQuotationController::class)->group(function () {
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::post('/sellers/update_gst_status', 'updateGstStatus')->name('sellers.update_gst_status');
