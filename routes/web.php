...
Route::get('send-mail/{user_id}', [MailController::class, 'index'])->name('property_owner.mail');
...
//test to admin Login
// Route::get('/admin_login', 'showLoginForm')->name('admin.login');
// Route::post('/admin_login', 'login')->name('admin.login.submit');
//test to admin Login

    // mycode starts
    Route::post('/newlogin', 'newlogin')->name('newlogin.login');
    // mycode starts
    Route::post('/check-email-exists', 'checkEmailExists')->name('check_email');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/setCurrentLocation/{id}', 'setCurrentLocation')->name('set.current.location');
    ...
    // Quotations
    Route::controller(HomeController::class)->group(function () {
        Route::post('/quotation/all', 'quotation_view')->name('quotation.view');
    });
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/product-queries/update/{id}', [ProductQueryController::class, 'update'])->name('front.product-query.update');
