...
class ReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($product->added_by == 'seller'){
            ...
            $body = "⭐ Customer Review Alert!<br>
                Your product ".$product->name." received a new review. Tap to read and respond.";
            sendSellerNotification($seller->user_id, 'seller_product_rating', null, null, null, $body);
        }
        else
        {
            $admin = User::where('user_type', 'admin')->first();
            $body = "🌟 New Product Review!<br>
                Customer reviewed ".$product->name." by ".$product->user->name.". Tap to review and moderate.";
            sendAdminNotification($admin->id, 'admin_product_rating', null, null, null, $body);
        }
