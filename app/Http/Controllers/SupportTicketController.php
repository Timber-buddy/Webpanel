...
class SupportTicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($ticket->save()){
            ...
            $body = "🆘 New Support Ticket from Customer!<br>
                Customer ".Auth::user()->name." needs assistance. Ticket: #".$ticket->code.". Tap to review and assist.";

            sendAdminNotification($admin->id, 'support_ticket_by_customer', null, $ticket->id, null, $body);
    ...
    public function admin_store(Request $request)
    {
        ...
        if($ticket_reply->save()){
            ...
            {
                $body = "🔔 Support Ticket Response!<br>
                    Your ticket #".$ticket->code." has been addressed.<br>
                    Tap to read our response.";

                sendSellerNotification($ticket->user_id, 'seller_ticket_reply', $ticket->code, $ticket->id, $ticket->status, $body);
            }
            else
            {
                $body = "🔔 Support Ticket Update!<br>
                    Your ticket #".$ticket->code." has a new response.<br>
                    Tap to view the details.";

                sendNotification($ticket->user_id, 'support_ticket_reply', $ticket->code, $ticket->id, $ticket->status, $body);
            }
