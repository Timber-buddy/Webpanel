...
class SupportTicketController extends Controller
{
    ...
    {
        $tickets = Ticket::where('user_id', getSellerId())->orderBy('created_at', 'desc')->paginate(9);
    ...
    public function store(Request $request)
    {
        ...
        if($ticket->save()){
            ...
            $seller = User::find(getSellerId());
            
            $body = "🆘 New Support Ticket from Seller!<br>
                Seller ".$seller->name." needs assistance. Ticket: #".$ticket->code.". Tap to review and assist.";

            sendAdminNotification($admin->id, 'support_ticket_by_seller', null, $ticket->id, null, $body);
