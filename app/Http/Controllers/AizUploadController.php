...
class AizUploadController extends Controller
{
    public function index(Request $request)
    {
        ...
        elseif(auth()->user()->user_type == 'staff')
        {
            ...
            if(isset($roles[0]->created_by) && $roles[0]->created_by > 0)
            {
                $all_uploads = Upload::where('user_id', $roles[0]->created_by);
            }
            else
            {
        ...
        if(auth()->user()->user_type == 'seller')
        {
            return view('seller.uploads.index', compact('all_uploads', 'search', 'sort_by'));
        }
        elseif(auth()->user()->user_type == 'staff')
        {
            $roles = Auth()->user()->roles;
    ...
    public function file_info(Request $request)
    {
        ...
        if(auth()->user()->user_type == 'seller')
        {
            return view('seller.uploads.info', compact('file'));
        }
        elseif(auth()->user()->user_type == 'staff')
        {
            $roles = Auth()->user()->roles;
