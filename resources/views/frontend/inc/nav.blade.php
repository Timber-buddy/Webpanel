            ...
            <div class="col-7 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    <li class="list-inline-item mr-3 pl-0 py-2" style="width: 300px;">
                        <select class="form-control form-control-sm aiz-selectpicker rounded-0" data-live-search="true"
            ...
            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="search-input-box">
                                    ...
                                    <svg id="Group_723" data-name="Group 723" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        style="right: 5px;width: 8%;background: white;">
                ...
                @if (!isAdmin())
                    ...
                    <ul class="list-inline mb-0 h-100 d-none d-xl-flex justify-content-end align-items-center">
                        <li class="list-inline-item ml-3 mr-3 pr-3 pl-0 dropdown" data-toggle="tooltip"
                            data-title="{{ translate('Notification') }}" data-placement="top">
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    @if ($notification->type == 'App\Notifications\SupportNotification')
                                                        <a href="{{ route('support_ticket.show', encrypt($notification->data['id'])) }}"
                                                            class="text-secondary fs-12">
                                                            <span class="ml-2">
                                                                {{ translate($notification->data['body']) }} against ticket
                                                                Id #{{ $notification->data['code'] }} with status
                                                    ...
                                                    @if (Auth::user()->user_type == 'seller')
                                                        @if ($notification->type == 'App\Notifications\SellerNotification')
                                                            <p class="mb-1 text-truncate-2">
                                                                @if (
                                                                    $notification->data['notification_key'] == 'shop_approval' ||
                                                                        $notification->data['notification_key'] == 'reset_password' ||
                                                                        $notification->data['notification_key'] == 'product_deleted' ||
                                                                        $notification->data['notification_key'] == 'seller_ban')
                                                                    {{ $notification->data['body'] }}
                                                                @elseif(
                                                                    $notification->data['notification_key'] == 'seller_flash_deal' ||
                                                                        $notification->data['notification_key'] == 'product_approved' ||
                                                                        $notification->data['notification_key'] == 'product_unpublished')
                                                                    <a
                                                                        href="{{ route('seller.products.edit', $notification->data['id']) }}">
                                                                        {{ $notification->data['body'] }}
                                                                    </a>
                                                                @elseif($notification->data['notification_key'] == 'seller_ticket_reply')
                                                                    <a
                                                                        href="{{ route('seller.support_ticket.show', encrypt($notification->data['id'])) }}">
                                                                        {{ $notification->data['body'] }} against ticket Id
                                                                        #{{ $notification->data['slug'] }} with status
                                                                        {{ $notification->data['status'] }}
                                                                    </a>
                                                                @elseif($notification->data['notification_key'] == 'seller_product_enquiry')
                                                                    <a
                                                                        href="{{ route('seller.product_query.show', encrypt($notification->data['id'])) }}">
                                                                        {{ $notification->data['body'] }}
                                                                    </a>
                                                                ...
                                                                @elseif($notification->data['notification_key'] == 'seller_product_quotation')
                                                                    <a
                                                                        href="{{ route('seller.quotation.view', encrypt($notification->data['id'])) }}">
                                                                        {{ $notification->data['body'] }}
                                                                    </a>
                                                                @endif
                                                            </p>
                                                    ...
                                                    @if ($notification->type == 'App\Notifications\SellerFollow')
                                                        <a href="{{ route('shop.visit', $notification->data['slug']) }}"
                                                            class="text-secondary fs-12">
                                                            <span class="ml-2">
                                                                {{ translate($notification->data['body']) }}
                                                            </span>
