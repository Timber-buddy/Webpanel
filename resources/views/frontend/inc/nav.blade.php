        ...
        <div class="row">
            ...
            <div class="col-7 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    <li class="list-inline-item mr-3 pl-0 py-2" style="width: 300px;">
                        <select class="form-control form-control-sm aiz-selectpicker rounded-0" data-live-search="true" onchange="changeLocation(this.value)">
                                    ...
                                    @if(!is_null($location->cities))
                                        @foreach($location->cities as $city)
                                            @if(in_array($city->id, $cities))
                                                <option value="{{$city->id}}" @isset($selected_location) @if ($selected_location == $city->id) selected @endif @endisset>
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <ul class="list-inline mb-0 h-100 d-none d-xl-flex justify-content-end align-items-center">
                    <li class="list-inline-item ml-3 mr-3 pr-3 pl-0 dropdown" data-toggle="tooltip" data-title="{{ translate('Notification') }}" data-placement="top">
                                        ...
                                        @forelse(Auth::user()->unreadNotifications as $notification)
                                            <li class="list-group-item">
                                                ...
                                                @if($notification->type == 'App\Notifications\CustomerNotification')
                                                    <span class="ml-2">
                                                        {{translate($notification->data['body'])}}
                                                    </span>
                                                @endif

                                                @if($notification->type == 'App\Notifications\ProductNotification')
                                                    @if(Auth::user()->user_type == 'customer')
                                                    <a href="{{route('product', $notification->data['slug'])}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                                                    @elseif (Auth::user()->user_type == 'seller')
                                                        <a href="{{ route('seller.products.edit', $notification->data['id']) }}" class="text-secondary fs-12">
                                                            <span class="ml-2">
                                                                {{translate($notification->data['body'])}}
                                                            </span>
                                                        </a>
                                                ...
                                                @if($notification->type == 'App\Notifications\FlashSaleNotification')
                                                    <a href="{{route('flash-deal-details', $notification->data['slug'])}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                                                ...
                                                @if($notification->type == 'App\Notifications\CmsNotification')
                                                    <a href="{{route('custom-pages.show_custom_page', $notification->data['slug'])}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                                                ...
                                                @if($notification->type == 'App\Notifications\CartNotification')
                                                    <a href="{{route('cart')}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                                                ...
                                                @if($notification->type == 'App\Notifications\WishlistNotification')
                                                    <a href="{{route('wishlists.index')}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                                                ...
                                                @if($notification->type == 'App\Notifications\CompareNotification')
                                                    <a href="{{route('compare')}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                                                ...
                                                @if($notification->type == 'App\Notifications\SupportNotification')
                                                    <a href="{{route('support_ticket.show', encrypt($notification->data['id']))}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}} against ticket Id #{{$notification->data['code']}} with status {{$notification->data['status']}}
                                                        </span>
                                                    </a>
                                                @endif
                                                ...
                                                @if($notification->type == 'App\Notifications\QuotationNotification')
                                                    <a href="{{route('quotation.show', $notification->data['id'])}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                                                ...
                                                @if(Auth::user()->user_type == 'seller')
                                                    @if($notification->type == 'App\Notifications\SellerNotification')
                                                        <p class="mb-1 text-truncate-2">
                                                            @if($notification->data['notification_key'] == "shop_approval" || $notification->data['notification_key'] == "reset_password" || $notification->data['notification_key'] == "product_deleted" || $notification->data['notification_key'] == "seller_ban")
                                                                {{$notification->data['body']}}
                                                            @elseif($notification->data['notification_key'] == "seller_flash_deal" || $notification->data['notification_key'] == "product_approved" || $notification->data['notification_key'] == "product_unpublished")
                                                            ...
                                                            @elseif($notification->data['notification_key'] == "seller_ticket_reply")
                                                                <a href="{{ route('seller.support_ticket.show', encrypt($notification->data['id'])) }}">
                                                                    {{$notification->data['body']}} against ticket Id #{{$notification->data['slug']}} with status {{$notification->data['status']}}
                                                                </a>
                                                ...
                                                @if($notification->type == 'App\Notifications\ConversationNotification')
                                                    <a href="{{route('conversations.show', encrypt($notification->data['id']))}}" class="text-secondary fs-12">
                                                        <span class="ml-2">
                                                            {{translate($notification->data['body'])}}
                                                        </span>
                                                    </a>
                ...
                <div class="ml-auto mr-0">
                    ...
                    @else
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info ml-3">
                            ...
                            <a href="{{ route('user.registration') }}" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2">{{ translate('Sign Up')}}</a>
                        </span>
                    @endauth
                </div>
            </div>
                ...
                <div class="position-static float-right">
                    <div class="aiz-user-top-menu bg-white rounded-0 border-top shadow-sm" style="width:220px;">
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            ...
                            @elseif(isSeller())
                                <li class="user-top-nav-element border border-top-0" data-id="1">
                                    <a href="{{ route('seller.dashboard') }}" class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                            <path id="Path_2916" data-name="Path 2916" d="M15.3,5.4,9.561.481A2,2,0,0,0,8.26,0H7.74a2,2,0,0,0-1.3.481L.7,5.4A2,2,0,0,0,0,6.92V14a2,2,0,0,0,2,2H14a2,2,0,0,0,2-2V6.92A2,2,0,0,0,15.3,5.4M10,15H6V9A1,1,0,0,1,7,8H9a1,1,0,0,1,1,1Zm5-1a1,1,0,0,1-1,1H11V9A2,2,0,0,0,9,7H7A2,2,0,0,0,5,9v6H2a1,1,0,0,1-1-1V6.92a1,1,0,0,1,.349-.76l5.74-4.92A1,1,0,0,1,7.74,1h.52a1,1,0,0,1,.651.24l5.74,4.92A1,1,0,0,1,15,6.92Z" fill="#b5b5c0"/>
                                        </svg>
                                        <span class="user-top-menu-name has-transition ml-3">{{ translate('Dashboard') }}</span>
                            ...
                            @if (isCustomer())
                                ...
                                <a href="{{ route('quotation.index') }}"
                                    ...
                                    <span
                                        class="user-top-menu-name text-primary has-transition ml-3">{{ translate('Quotations') }}</span>
                                </a>
                            </li>
                            @endif
                            <li class="user-top-nav-element border border-top-0" data-id="1">
