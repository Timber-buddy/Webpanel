    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <h1 class="fw-700 fs-20 fs-md-24 text-dark text-center mb-3">{{ translate('Register Your Organization')}}</h1>
                <form id="shop" class="" action="{{ route('shops.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white border mb-4">
                        ...
                        <div class="p-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0{{ $errors->has('shop_name') ? ' is-invalid' : '' }}" value="{{ old('shop_name') }}" placeholder="{{ translate('Organization Name')}}" name="shop_name" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm aiz-selectpicker rounded-0" data-live-search="true" name="city" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0{{ $errors->has('gst_number') ? ' is-invalid' : '' }}" value="{{ old('gst_number') }}" placeholder="{{ translate('GST Number')}}" name="gst_number" id="gst_number" required onkeyup="gstNumberValidation()">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm aiz-selectpicker rounded-0" data-live-search="true" name="subscription_plan" onchange="getPlanDetails(this.value)">
                    ...
                    <div class="text-right">
                        <button type="submit" id="subBtn" class="btn btn-primary fw-600 rounded-0">{{ translate('Register Your Organization')}}</button>
                    </div>
                </form>
            </div>
        </div>
