<div class="text-left">
    ...
    <div class="d-flex flex-wrap align-items-center">
        <div class="d-flex align-items-center mr-4">
            ...
            @else
                <p class="mb-0 fs-14 fw-700">{{ translate('The Timber Buddy product') }}</p>
            @endif
        </div>
        <!-- Messase to seller -->
                    ...
                    <div class="modal-body">
                        <div class="row p-0 mb-3" style="border-bottom: 2px solid #91919b9c;">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="text-secondary fs-6 fw-500">{{ translate('Price') }}</div>
                                    </div>
                                    <div class="col-sm-8 text-right">
                                        <div class="d-flex align-items-center">
                                            <!-- Discount Price -->
                                            <strong class="fs-16 fw-700 text-primary" id="discountedPrice">
                                                {{ home_discounted_price($detailedProduct) }}
                                            </strong>
                                            <!-- Home Price -->
                                            <del class="fs-14 opacity-60 ml-2">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <img class="img-fit" src="https://thetimberbuddy.com/public/Success.jpeg"
