        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="row gutters-5 gutters-md-16">
                    ...
                    <div class="col-xxl-4 col-lg-5 col-6 h-200px= h-md-475px h-lg-475px">
                                            ...
                                            @if ($product != null && $product->published != 0)
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ $product_url }}"
                                                        ...
                                                        <!-- Price -->
                                                        <div
                                                            class="fs-10 fs-md-14 mt-md-3 text-center h-md-48px has-transition overflow-hidden pt-md-3 flash-deal-price">
                                                            <span
                                                                class="d-block text-primary fw-700 product_name">{{ $product->getTranslation('name') }}</span>
                                                            <span
