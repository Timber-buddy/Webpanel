                ...
                <table class="table table-bordered aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="lg">{{ translate('Total Received Quotation') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $num_of_quotation = 0;
                                            foreach ($seller->user->products as $key => $product) {
                                                $num_of_quotation += count($product->num_of_quotation);
                                            }
                                        @endphp
                                        {{ $num_of_quotation }}
                                    </td>
                                    <td>
                                        ...
                                        @php
                                             $productCount = count($seller->user->products);
                                            //$quotation_product = 0;

                                            // $quotation_product = 0;
                                            // foreach ($seller->user->products as $key => $product) {
                                            //     $quotation_product += count($product->quotation_product);
                                            // }
