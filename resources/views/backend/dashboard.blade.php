    ...
    @endphp
                    ...
                    <div class="col-6">
                        <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                ...
                                <div class="h3 fw-700 mb-3">
                                    {{ \App\Models\Quotation::where('seller_id', $userMasterId)->count() }}</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                                <path fill="rgba(255,255,255,0.3)" fill-opacity="1"
                                    d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z">
        ...
        <div class="row gutters-10">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0 fs-14">{{ translate('Category wise product quotation') }}</h6>
                    </div>
                                ...
                                <div class="form-group row" >
                                    ...
                                    <div class="col-md-5">
                                        <select class="from-control aiz-selectpicker" name="verification_status" required>
                                            ...
                                            <option value="1" @if($sort_by == '1') selected @endif>{{ translate('Timber buddy Quotation') }}</option>
                                            <option value="2" @if($sort_by == '2') selected @endif>{{ translate('Sellers Quotation') }}</option>
                                            <option value="0" @if($sort_by == '0') selected @endif>{{ translate('All Quotation') }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"
                    ...
                    @foreach (\App\Models\Product::where('published', 1)->orderBy('num_of_sale', 'desc')->limit(12)->get() as $key => $product)
    ...
    <script type="text/javascript">
        ...
        AIZ.plugins.chart('#graph-1', {
            ...
            data: {
                ...
                datasets: [{
                    label: '{{ translate('Number of quotations') }}',
                    data: [
