...
<div class="">
    ...
    @endif
    <form class="form form-horizontal mar-top" onsubmit="return validateForm()" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="name" id="name" placeholder="{{translate('Product Name')}}" value="{{ $product->getTranslation('name', $lang) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="unit" id="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" value="{{$product->getTranslation('unit', $lang)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <br /><span id="tagsError" class="error"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                    ...
                                    <input type="hidden" name="photos" id="photo" value="{{ $product->photos }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                                <br /> <span id="photoError" class="error"></span>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="thumbnail_img" id="thumbnail" value="{{ $product->thumbnail_img }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="video_link" id="video_link" value="{{ $product->video_link }}" placeholder="{{ translate('Video Link') }}">
                                <br> <span id="video_linkError" class="error"></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span id="choseError" class="error"></span>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" placeholder="{{translate('Unit price')}}" name="unit_price" id="unit_price" class="form-control" value="{{$product->unit_price}}">
                                <span id="unit_priceError" class="error"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Discount')}}" name="discount" class="form-control" id="discount" value="{{ $product->discount??'0' }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea class="aiz-text-editor" name="description" id="description">{{ $product->getTranslation('description', $lang) }}</textarea>
    ...
    function validateForm() {
           ...
           // alert(discount);
            ...
            if (discount === '') {
                ...
                AIZ.plugins.notify('danger', '{{ translate('Discount is required') }}');
                return false;
            }
