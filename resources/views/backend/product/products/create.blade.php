    ...
    <div class="">
        ...
        @if (request()->has('errorMessage'))
            <div class="alert alert-danger">
                <ul>
                    @foreach (request('errorMessage') as $error)
                        <div>{{ $error }}</div>
                    @endforeach
                </ul>
            </div>
                ...
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Tags') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" id="tags" class="form-control aiz-tag-input" name="tags[]"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                    for="signinSrEmail">{{ translate('Gallery Images') }} <span
                                        class="text-danger">*</span> <small>(600x600)</small>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image"
                                        ...
                                        <input type="hidden" name="photos" id="photo"
                                            class="selected-files {{ $errors->has('photos') ? ' is-invalid' : '' }}">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                    for="signinSrEmail">{{ translate('Thumbnail Image') }} <span
                                        class="text-danger">*</span> <small>(300x300)</small>
                                </label>
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        <div class="input-group-prepend">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Unit price') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="0" value="" step="0.01"
                                        placeholder="{{ translate('Unit price') }}" name="unit_price" id="unit_price"
