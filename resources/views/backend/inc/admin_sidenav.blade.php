    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (addon_is_activated('pos_system') &&
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            @endif
                            <span class="aiz-side-nav-arrow"></span>Addon Manager
                        </a>
                            ...
                            @can('show_in_house_products')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('products.admin') }}"
                                        ...
                                        <span class="aiz-side-nav-text">Timber Buddy Products</span>
                                        {{-- <span class="aiz-side-nav-text">{{ translate('Timber Buddy Products') }}</span> --}}
                                    </a>
                                </li>
                            @endcan
                                ...
                                @can('view_inhouse_wholesale_products')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('wholesale_products.in_house') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['wholesale_product_edit.admin']) }}">
                                            <span
                                                class="aiz-side-nav-text">{{ translate('Timber Buddy Wholesale Products') }}</span>
                                        </a>
                                    </li>
                                @endcan
                ...
                @canany(['view_quotation', 'quotation_details', 'quotation_reply'])
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('quotation.all') }}" class="aiz-side-nav-link">
                            <i class="las la-money-bill aiz-side-nav-icon"></i>
                            ...
                            @can('in_house_product_sale_report')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('in_house_sale_report.index') }}"
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('Timber Buddy Product Quotation') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('seller_products_sale_report')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('seller_sale_report.index') }}"
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('Seller Products Quotation') }}</span>
                                    </a>
                                </li>
                            @endcan
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @if (get_setting('coupon_system') == 1 &&
                                    auth()->user()->can('view_all_coupons'))
                                <li class="aiz-side-nav-item">
                ...
                <!-- Subscriptions -->
                @canany(['subscription_plan_view', 'subscription_plan_create', 'subscription_plan_edit',
                    'subscription_plan_delete', 'purchase_history_view', 'purchase_history_edit',
                    'purchase_history_delete'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-ruler aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Subscriptions') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @canany(['subscription_plan_view', 'subscription_plan_create', 'subscription_plan_edit',
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('subscriptions.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Subscription Plans') }}</span>
                                    </a>
                                </li>
                            @endcanany
                            @canany(['purchase_history_view', 'purchase_history_edit', 'purchase_history_delete'])
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('subscription.payments') }}" class="aiz-side-nav-link">
                ...
                @if (addon_is_activated('paytm') &&
                        auth()->user()->can('asian_payment_gateway_configuration'))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
