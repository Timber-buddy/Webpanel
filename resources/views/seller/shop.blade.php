    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('GST Number') }} <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-10">
                        <input type="text" class="form-control" placeholder="{{ translate('GST Number')}}" name="gst_number" id="gst_number" value="{{ $shop->gst_number }}" required onkeyup="gstNumberValidation()">
                        <span class="text-danger mb-3" id="errGst"></span>
                        @if($shop->gst_number_status != "Verified")
                            @if(!is_null($shop->gst_number_status))
                                <div style="margin-bottom: 10px;">
                                    <b>{{translate('GSTIN Verification Status')}} : &ensp;</b>
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control form-control-sm aiz-selectpicker rounded-0 mb-3" data-live-search="true" name="city">
                ...
                <div class="form-group mb-0 text-right">
                    <button type="submit" id="subBtn" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
                </div>
            </form>
        </div>
    </div>
