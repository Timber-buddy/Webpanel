...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		@if(checkSellerPermission('add_uploaded_files'))
...
<div class="card">
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5">
            ...
            @if(checkSellerPermission('edit_uploaded_files'))
				...
				@foreach($all_uploads as $key => $file)
					...
					<div class="col-auto w-140px w-lg-220px">
						<div class="aiz-file-box">
							@if(checkSellerPermission('detail_uploaded_files') || checkSellerPermission('download_uploaded_files') || checkSellerPermission('link_uploaded_files') || checkSellerPermission('delete_uploaded_files'))
								<div class="dropdown-file" >
									<a class="dropdown-link" data-toggle="dropdown">
										<i class="la la-ellipsis-v"></i>
									</a>
									<div class="dropdown-menu dropdown-menu-right">
										@if(checkSellerPermission('detail_uploaded_files'))
										...
										@endif
										@if(checkSellerPermission('download_uploaded_files'))
										...
										@endif
										@if(checkSellerPermission('link_uploaded_files'))
										...
										@endif
										@if(checkSellerPermission('delete_uploaded_files'))
