...
@section('panel_content')
    ...
    <form class="" onsubmit="return validateForm()" action="{{ route('seller.products.update', $product->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label"
                                for="signinSrEmail"><b>{{ translate('Gallery Images') }}</b>
                                <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label"
                                for="signinSrEmail"><b>{{ translate('Thumbnail Image') }}</b>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control aiz-selectpicker attribute_choice"
                                            ...
                                            name="choice_options_{{ $choice_option->attribute_id }}[]" multiple required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" placeholder="{{ translate('Unit price') }}" name="unit_price"
                                    class="form-control" id="unit_price" value="{{ $product->unit_price }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" lang="en"
                                        value="{{ $product->stocks->first()->qty ?? 0 }}" step="1"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="{{ translate('SKU') }}"
                                        value="{{ $product->stocks->first()->sku ?? '' }}" name="sku"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label"><b>{{ translate('Description') }}</b>
                                <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <textarea class="aiz-text-editor" id="description" name="description">{{ $product->getTranslation('description', $lang) }}</textarea>
