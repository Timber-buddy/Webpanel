...
@section('panel_content')
    ...
    <div class="row gutters-10 justify-content-center">
        @if(checkSellerPermission('add_digital_product'))
                ...
                <tbody>
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                                @if(checkSellerPermission('edit_digital_product'))
                                ...
                                @endif
                                @if(checkSellerPermission('download_digital_products'))
                                ...
                                @endif
                                @if(checkSellerPermission('delete_digital_product'))
