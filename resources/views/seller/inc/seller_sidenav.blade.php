    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(checkSellerPermission('show_all_products') || checkSellerPermission('product_bulk_import') || checkSellerPermission('show_digital_products') || checkSellerPermission('show_product_review'))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(checkSellerPermission('show_all_products'))
                                <li class="aiz-side-nav-item">
                            ...
                            <!--Digital Products-->
                            <!--
                            @if(checkSellerPermission('show_digital_products'))
                            <li class="aiz-side-nav-item">
                            ...
                            @endif
                            -->
                            @if(checkSellerPermission('show_product_review'))
                            <li class="aiz-side-nav-item">
                ...
                @endif
                @if(checkSellerPermission('view_uploaded_files'))
                <li class="aiz-side-nav-item">
                ...
                <!--Quotations Starts-->
                @if(checkSellerPermission('view_quotations'))
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.quotation.all') }}"
                ...
                @if(checkSellerPermission('shop_setting'))
                    <li class="aiz-side-nav-item">
                ...
                @if(checkSellerPermission('payment_history'))
                    <li class="aiz-side-nav-item">
                ...
                @if(checkSellerPermission('list_conversations'))
                ...
                @if(checkSellerPermission('list_queries'))
                ...
                @if(checkSellerPermission('support_ticket'))
                    @php
                ...
                @if(checkSellerPermission('view_staff') || checkSellerPermission('roles_and_permissions'))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(checkSellerPermission('view_staff'))
                                <li class="aiz-side-nav-item">
                                    <a href="{{ url('/seller/staff/all') }}"
                                        class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('All staffs')}}</span>
                                    </a>
                                </li>
                            @endif
                            @if(checkSellerPermission('roles_and_permissions'))
                                <li class="aiz-side-nav-item">
                                    <a href="{{ url('/seller/staff/permission') }}"
                                        class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Staff Roles and Permissions')}}</span>
                                    </a>
                                </li>
                            @endif
                        </ul>
