...
@section('panel_content')
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-xxl-4">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h3 class="mb-0 text-white fs-30">
                                {{ \App\Models\Product::where('user_id', $userMasterId)->count() }}
                            </h3>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">{{ translate('Total Quotations') }}</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                {{ \App\Models\Quotation::where('seller_id', $userMasterId)->count() }}
                            </h3>
                        </div>
                        <div class="col-auto text-right">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h3 class="mb-0 text-white fs-30">
                                @php
                                    $orderDetails = \App\Models\OrderDetail::where('seller_id', $userMasterId)->get();
                                    $total = 0;
        ...
        <div class="col-sm-6 col-md-6 col-lg-4 mb-4">
            <div class="card shadow-none bg-soft-primary">
                <div class="card-body">
                    ...
                    @php
                        $quotationCount = \App\Models\Quotation::where('seller_id', $userMasterId)->count();
                    @endphp
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        @foreach (\App\Models\Category::all() as $key => $category)
                            @if (count($category->products->where('user_id', $userMasterId)) > 0)
                                <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                                    {{ $category->getTranslation('name') }}
                                    <span class="">
                                        {{ count($category->products->where('user_id', $userMasterId)) }}
                                    </span>
                                </li>
                            @endif
                        @endforeach
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{ \App\Models\OrderDetail::where('seller_id', $userMasterId)->where('delivery_status', 'pending')->count() }}
                            </h3>
                        </div>
                    </div>
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{ \App\Models\OrderDetail::where('seller_id', $userMasterId)->where('delivery_status', 'cancelled')->count() }}
                            </h3>
                        </div>
                    </div>
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{ \App\Models\OrderDetail::where('seller_id', $userMasterId)->where('delivery_status', 'on_the_way')->count() }}
                            </h3>
                        </div>
                    </div>
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            ...
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{ \App\Models\OrderDetail::where('seller_id', $userMasterId)->where('delivery_status', 'delivered')->count() }}
                            </h3>
                        </div>
                    </div>
...
@section('script')
        ...
        AIZ.plugins.chart('#graph-1', {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#2E294E', '#2E294E', '#2E294E', '#2E294E', '#2E294E', '#2E294E', '#2E294E', 'rgba(255, 99, 132, 0.2)' ],
                    borderColor: ['#2E294E', '#2E294E', '#2E294E', '#2E294E', '#2E294E', '#2E294E', '#2E294E', 'rgba(255, 99, 132, 1)'],
                    borderWidth: 1
                }]
            },
            options: {
    ...
    AIZ.plugins.chart('#graph-1', {
        ...
        data: {
            ...
            datasets: [{
                label: '{{ translate('Number of Quotation Raised') }}',
                data: [
                    @foreach ($categories as $category)
